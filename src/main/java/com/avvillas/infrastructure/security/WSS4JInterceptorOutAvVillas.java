...
/**
 * Interceptor para las peticiones de RESPUESTA de los controladores soap para AvVillas
 */
@ApplicationScoped
@Named("interceptorOutAvVillas")
public class WSS4JInterceptorOutAvVillas extends WSS4JOutInterceptor {

    public WSS4JInterceptorOutAvVillas() {
