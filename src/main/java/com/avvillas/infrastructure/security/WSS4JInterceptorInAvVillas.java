...
/**
 * Interceptor para las peticiones de ENTRADA de los controladores soap para AvVillas
 */
@ApplicationScoped
@Named("interceptorInAvVillas")
public class WSS4JInterceptorInAvVillas extends WSS4JInInterceptor {

    public WSS4JInterceptorInAvVillas() {
